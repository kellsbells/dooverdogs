...
<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="659.000000pt" height="153.000000pt" viewBox="0 0 659.000000 113.000000"
					...
					while ( $loop->have_posts() ) : $loop->the_post();
					  ...
					  <a href="<?php the_permalink(); ?>" class="single dog">
						...
						<div class="single text">
							...
							<p>All of our adoptable dogs are in foster homes throughout Colorado and Wyoming. We utilize the loving homes of our fosters to bridge the connection from death row, to a forever home. Prior to adoption each Do Over Dog is spayed/neutered, microchiped, and has been administered a rabies vaccine, DH2PP, and a heartworm test. To meet a pet you're interested in contact us today!</p>

							<p>Sometimes we receive multiple applications for each pup. Priority is given in the order of submitted applications provided that the adopter and pup are a forever fit for each other.</p>
						</div>
					  <?php
					endwhile;
				?>		
				...
				<div class="help-wrapper">
					...
					<div class="link-farm">
						...
						<a href="/volunteer" class="help-link">
							<div class="photo" style="background: url(<?php echo $imagedir ?>/dod-4.jpg) no-repeat center center; background-size: cover;">
							</div>
							<div class="cta">
